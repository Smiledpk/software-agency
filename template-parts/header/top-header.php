	  	...
	  	<div class="row">
	  		<div class="col-lg-8 col-md-7">
			    <?php if( get_theme_mod('software_agency_top_bar_text') != ''){ ?>
		      		<p class="py-2 py-lg-3 py-md-3 mb-0 text-center text-md-left text-lg-left"><?php echo esc_html(get_theme_mod('software_agency_top_bar_text',''));?></p>
			    <?php } ?>
			</div>
			<div class="col-lg-4 col-md-5">
				<div class="text-center text-md-right text-lg-right">
					<?php if( get_theme_mod('software_agency_support_link') != '' || get_theme_mod('software_agency_support_text') != ''){ ?>
			      		<a href="<?php echo esc_url(get_theme_mod('software_agency_support_link',''));?>" class="py-2 py-lg-3 py-md-3 mr-2 d-inline-block"><?php echo esc_html(get_theme_mod('software_agency_support_text',''));?></a>/
				    <?php } ?>
				    <?php if( get_theme_mod('software_agency_wishlist_link') != '' || get_theme_mod('software_agency_wishlist_text') != ''){ ?>
			      		<a href="<?php echo esc_url(get_theme_mod('software_agency_wishlist_link',''));?>" class="py-2 py-lg-3 py-md-3 mr-2 d-inline-block"><?php echo esc_html(get_theme_mod('software_agency_wishlist_text',''));?></a>/
				    <?php } ?>
