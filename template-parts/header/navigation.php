      ...
      <div class="col-lg-9 col-md-7 col-3 border-right">
        <?php if(has_nav_menu('primary')){ ?>
          <div class="toggle-nav mobile-menu">
            <button role="tab" onclick="software_agency_menu_open_nav()" class="responsivetoggle"><i class="fas fa-bars p-3"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','software-agency'); ?></span></button>
          </div>
        <?php } ?>
        <div id="mySidenav" class="nav sidenav">
          <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'software-agency' ); ?>">
            ...
            <a href="javascript:void(0)" class="closebtn mobile-menu" onclick="software_agency_menu_close_nav()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Button','software-agency'); ?></span></a>
          </nav>
        </div>
      </div>
