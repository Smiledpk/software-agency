...
<h2 class="entry-title"><?php esc_html_e( 'Nothing Found', 'software-agency' ); ?></h2>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'software-agency' ); ?></p><br />
		<?php get_search_form(); ?>
	<?php else : ?>
